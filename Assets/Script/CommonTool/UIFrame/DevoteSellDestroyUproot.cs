...
public class DevoteSellDestroyUproot : MonoBehaviour
{
[UnityEngine.Serialization.FormerlySerializedAs("needStartRefresh")]    public bool CornAloneGenetic= true;
    ...
    public void LopDestroyUproot()
    {
        Vector2 cellSize = GetComponent<GridLayoutGroup>().cellSize;
        Vector2 Evident= GetComponent<GridLayoutGroup>().spacing;
        ...
        float height = spaceTop + spaceBottom + lineCount * cellSize.y + (lineCount - 1) * Evident.y;
