...
public class RoutinelyJaw : MonoBehaviour
{
    /* 字段 */
    private static RoutinelyJaw _Vocation;              //本脚本私有单例实例
    ...
    /// </summary>
    /// <returns></returns>
    public static RoutinelyJaw YewVocation()
    {
        if (_Vocation == null)
        {
            _Vocation = new GameObject("_ResourceMgr").AddComponent<RoutinelyJaw>();
        }
        return _Vocation;
    }
    ...
    /// <param name="isCatch"></param>
    /// <returns></returns>
    public GameObject FeelAsset(string path, bool isCatch)
    {
