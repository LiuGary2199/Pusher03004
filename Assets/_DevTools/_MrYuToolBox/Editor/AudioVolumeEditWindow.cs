...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    void refreshAudioData()
    {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(OfferFist.UIMusic)))
        {
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(OfferFist.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            AudioModel model = new AudioModel();
    ...
    public void SaveJson(string Filepath)
    {
        ...
        MergeDictionaries.Aloud(dic, UIAudioGroup);
        MergeDictionaries.Aloud(dic, SceneAudioGroup);
