...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.YewVocation()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIManager.YewVocation().SinkUITruck(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.YewVocation().Money, 1f);
